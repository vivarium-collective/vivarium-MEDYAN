...
medyan_chandrasekaran_2019_fibers = {
    "1": {
        ...
        "points": [
            np.array([500., 1500., 1500.]),
            np.array([2500., 1500., 1500.]),
        ],
    },
    "2": {
        "type_name": "Actin-Polymer",
        "points": [
            np.array([500., 1400., 1500.]),
            np.array([2500., 1400., 1500.]),
        ],
    },
    "3": {
        "type_name": "Actin-Polymer",
        "points": [
            np.array([500., 1600., 1500.]),
            np.array([2500., 1600., 1500.]),
        ],
    },
    "4": {
        "type_name": "Actin-Polymer",
        "points": [
            np.array([500., 1500., 1400.]),
            np.array([2500., 1500., 1400.]),
        ],
    },
    "5": {
        "type_name": "Actin-Polymer",
        "points": [
            np.array([500., 1500., 1600.]),
            np.array([2500., 1500., 1600.]),
        ],
    },
    # "1": {
    #     "type_name": "Actin-Polymer",
